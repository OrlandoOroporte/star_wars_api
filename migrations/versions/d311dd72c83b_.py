...
Revision ID: d311dd72c83b
Revises: 
Create Date: 2022-08-30 22:40:19.287209
...
def upgrade():
    ...
    sa.Column('color_eyes', sa.String(length=16), nullable=False),
    sa.Column('color_hair', sa.String(length=16), nullable=False),
    sa.Column('height', sa.String(length=16), nullable=False),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'name', name='message_unique')
    )
